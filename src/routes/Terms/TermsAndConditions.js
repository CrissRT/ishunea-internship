...
function TermsAndConditions() {
    ...
    const content = [
        <section id="terms-content">
            <div id="terms-heading">
                <h1 id="terms-title">{textTerms.title}</h1>
                <article id='terms-article'>
                    <p id="terms-intro">{textTerms.intro}</p>
                    <h3 className='terms-subheading'>{textTerms.firstSubheading}</h3>
                    <p className='terms-main-text'>{textTerms.firstParagraph}</p>

                    <h3 className='terms-subheading'>{textTerms.secondSubheading}</h3>
                    <p className='terms-main-text'>{textTerms.secondParagraph}</p>
                </article>
            </div>
  ...
  return (
    <>
        ...
        <Page  contentComponents={content} backgroundColor='white' paddingTop='168px'/>
        <Footer/>
    </>
  )
}
